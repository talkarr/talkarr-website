export const githubOrgLink = 'https://github.com/talkarr';
export const githubRepoLink = `${githubOrgLink}/talkarr`;
export const githubIssuesLink = `${githubRepoLink}/issues`;
